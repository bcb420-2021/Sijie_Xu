...
gsea_report_for_neg <- read.delim(file.path(working_dir,gsea_output_dir, 
                                            gsea_report_table[grepl("neg", gsea_report_table)]), stringsAsFactors = F)
gsea_report_for_pos <- read.delim(file.path(working_dir,gsea_output_dir, 
                                            gsea_report_table[grepl("pos", gsea_report_table)]), stringsAsFactors = F)
